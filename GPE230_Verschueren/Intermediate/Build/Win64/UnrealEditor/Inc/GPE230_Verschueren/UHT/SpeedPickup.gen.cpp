...
#include "GPE230_Verschueren/Public/SpeedPickup.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSpeedPickup() {}
// Cross Module References
	GPE230_VERSCHUEREN_API UClass* Z_Construct_UClass_APickups();
	GPE230_VERSCHUEREN_API UClass* Z_Construct_UClass_ASpeedPickup();
	GPE230_VERSCHUEREN_API UClass* Z_Construct_UClass_ASpeedPickup_NoRegister();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_speedBoost_MetaData[];
#endif
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpeedPickup_Statics::NewProp_speedBoost_MetaData[] = {
		{ "Category", "SpeedPickup" },
		{ "ModuleRelativePath", "Public/SpeedPickup.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpeedPickup_Statics::NewProp_speedBoost = { "speedBoost", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpeedPickup, speedBoost), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpeedPickup_Statics::NewProp_speedBoost_MetaData), Z_Construct_UClass_ASpeedPickup_Statics::NewProp_speedBoost_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpeedPickup_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpeedPickup_Statics::NewProp_speedBoost,
	};
	...
	template<> GPE230_VERSCHUEREN_API UClass* StaticClass<ASpeedPickup>()
	{
		return ASpeedPickup::StaticClass();
	}
	ASpeedPickup::ASpeedPickup(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ASpeedPickup);
	ASpeedPickup::~ASpeedPickup() {}
	struct Z_CompiledInDeferFile_FID_GPE230_Verschueren_Source_GPE230_Verschueren_Public_SpeedPickup_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GPE230_Verschueren_Source_GPE230_Verschueren_Public_SpeedPickup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpeedPickup, ASpeedPickup::StaticClass, TEXT("ASpeedPickup"), &Z_Registration_Info_UClass_ASpeedPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpeedPickup), 4223846661U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GPE230_Verschueren_Source_GPE230_Verschueren_Public_SpeedPickup_h_1760635747(TEXT("/Script/GPE230_Verschueren"),
		Z_CompiledInDeferFile_FID_GPE230_Verschueren_Source_GPE230_Verschueren_Public_SpeedPickup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GPE230_Verschueren_Source_GPE230_Verschueren_Public_SpeedPickup_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
